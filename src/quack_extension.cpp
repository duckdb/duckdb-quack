...
static void LoadInternal(ExtensionLoader &loader) {
	...
	config.AddExtensionOption("quack_append_flush_rows",
	                          "Rows a sink thread buffers before shipping one APPEND_REQUEST", LogicalType::UBIGINT,
	                          Value::UBIGINT(STANDARD_VECTOR_SIZE * 100ULL));
